 ...
 */
public interface BeaconActionRegistry {
    boolean isAvailable(BeaconMessage message) throws UnsupportedMessageException;

    List<BeaconAction> getBeaconActionsForMessage(BeaconMessage message)
            throws RegistryNotAvailableException, UnsupportedMessageException;

    // Exception classes
    class UnsupportedMessageException extends Exception {}

    class RegistryNotAvailableException extends Exception {}
}
