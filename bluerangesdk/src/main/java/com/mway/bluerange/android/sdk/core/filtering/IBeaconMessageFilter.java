 ...
 */
public class IBeaconMessageFilter extends BeaconMessageFilter  {

    public IBeaconMessageFilter(BeaconMessageStreamNode senderNode) {
        super(senderNode);
    }

    public IBeaconMessageFilter(List<BeaconMessageStreamNode> senderNodes) {
        super(senderNodes);
    }
